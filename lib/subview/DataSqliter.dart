...
class DataSqliter extends StatefulWidget {
  const DataSqliter({super.key});

  @override
  State<DataSqliter> createState() => _DataSqliterState();
}

 

class _DataSqliterState extends State<DataSqliter> {
  @override
...
void SqliterAbouts() async {
  ...
  Future<List<DogBean>> dogs() async {
    // Get a reference to the database.
    final db = await database;
