...
class _MsgPageState extends State<MsgPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      Container(
            height:160,
            child: Center(child: Text("界面消息",style: TextStyle(fontSize: 40.0,color:Colors.white),),),
      ),
    Container(
...
return Container(color: Color.fromARGB(255, 204, 73, 73),
margin: EdgeInsets.all( 1.0),
padding: EdgeInsets.all(20),
child: Text("item:$index",style: TextStyle(fontSize: 20.0,color:Colors.black87),),
);
        }
),
